...
public class SpoonacularTest {
    ...
    private static final String API_KEY = "2afb8bc7e10141b2b103451d6f4e3f7a";
...
//                .all()  here we can see "quota usage"
    ...
    JsonPath expectedJSON = new JsonPath(FileUtils.readFileToString(
            new File("src/test/resources/Margarita.postman_collection.json"), StandardCharsets.UTF_8));
